...
using UnityEngine;
    ...
    public class ColorEnvironmentController : MonoBehaviour
    {
    	...
    	private void OnGUI()
    	{
    		...
    		if (Input.touchCount > 0)
    			GUI.Label(new Rect(350f, 50.0f, 100.0f, 50.0f), (Input.GetTouch(0).pressure * 100.0f).ToString("0.00") + "% / " + (Input.GetTouch(0).maximumPossiblePressure * 100.0f).ToString("0.00"), fontStyle);
    	}
