...
using UnityEngine;
    ...
    public class NotificationManagerTouch : MonoBehaviour
    {
        private static NotificationManagerTouch _instance = null;
        public static NotificationManagerTouch Instance
        {
            get
            {
                if (_instance == null)
        ...
        void RegisterTrialNotification(System.DateTime notificationDate)
        {
            ...
            var notification = new iOSNotification()
            {
                ...
                Body = "Your trial expires in one day!",
        ...
        void RegisterOneDailyNotification(System.DateTime date, string notificationId)
        {
            ...
            var notification = new iOSNotification()
            {
                ...
                Body = "🖌🎨 What a wonderful time to color some drawings!\nGet your magic brush and let's have fun!", //"Continue learning, your kid deserves it.",
                //Subtitle = "This is a subtitle, something, something important...",
