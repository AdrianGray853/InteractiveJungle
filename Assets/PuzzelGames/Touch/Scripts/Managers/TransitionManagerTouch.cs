...
using UnityEngine.UI;
    ...
    public class TransitionManagerTouch : MonoBehaviour
    {
        ...
        System.Func<bool> waitConditionFunc = null;
        float waitContinueDuration = 1.0f;
        TweenCallback waitDoneCallback;

        static TransitionManagerTouch _instance = null;
        public static TransitionManagerTouch Instance
        {
            get
            {
                if (_instance == null)
        ...
        // This will teriminate fade and finish the Fade Sequence!
