    ...
    public class LetterPanelController : MonoBehaviour
    {
        ...
        public void PressContinue()
        {
            ...
            if (maxLetter >= 'A')
            {
                ...
                //ProgressManagerTouch.Instance.UnlockLevel(GameDataTouch.eGameType.LowerCase, targetLevelIdx);
                //ProgressManagerTouch.Instance.UnlockLevel(GameDataTouch.eGameType.UpperCase, targetLevelIdx);
            }
            OnBoardingControllerTouch.Instance.ShowAgeSelection();
        }
    }
