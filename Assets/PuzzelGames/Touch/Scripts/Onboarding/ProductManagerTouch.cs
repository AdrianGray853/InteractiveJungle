...
using UnityEngine.UI;
    ...
    public class ProductManagerTouch : MonoBehaviour, IDetailedStoreListener
    {

        private static ProductManagerTouch _instance = null;
        public static ProductManagerTouch Instance
        {
            get
            {
                if (_instance == null)
        ...
        private void Awake()
        {
            ...
            if (culture != null)
            {
                SubscriptionText = "then " + 19.99d.ToString("C", culture) + "/year (~" + 1.66d.ToString("C", culture) + "/month)"; //subscriptionProduct.metadata.localizedPrice.ToString("C", culture);
            }
    #else
        ...
        public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
        {
            ...
            ProgressManagerTouch.Instance.SetExpireDate(expireDate.ToBinary());
            ...
            { // TODO: This might not be correct as ProcessPurchase might come from restore or other events, find a better way to know when trial ends!
                NotificationManagerTouch.Instance.CreateTrialNotification(info.getPurchaseDate());
            }
