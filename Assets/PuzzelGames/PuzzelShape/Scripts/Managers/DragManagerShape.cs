...
using UnityEngine;
    ...
    public class DragManagerShape : MonoBehaviour
    {
    	public static DragManagerShape Instance  { get; private set; }
    	...
    	public delegate void OnReleaseDelegate(Touch touch, DragHelperShape helper);

    	Dictionary<int, DragHelperShape> dragHelpers = new Dictionary<int, DragHelperShape>();
    	...
    	void Update()
    	{
    		if (Input.touchCount > 0)
    		{
    			for (int i = 0; i < Input.touchCount; i++)
    			{
    				...
    				{
    					DragHelperShape dragHelper = dragHelpers.GetValueOrDefault(touch.fingerId);
    				...
    				{
    					DragHelperShape helper = dragHelpers.GetValueOrDefault(touch.fingerId);
    	...
    	{
    		DragHelperShape newDrag = new DragHelperShape(fingerId, objTransform, attachPosition, restrictOffset, isRigidBody);
