...
using UnityEngine;
    ...
    public class OnBoardingAgeInputShape : MonoBehaviour
    {
    	[System.Serializable]
    	...
    	public void PressEnter()
    	{
    		if (currentBox >= 4)
    		{
    			...
    			{
    				if (this.gameObject.name == "BirthdayScreen")
    				{
    					OnBoardingControllerShape.Instance.AcceptAge();
    				}
    				else
    				{
    					OnBoardingControllerShape.Instance.AcceptAgeForExternalLink();
    				}
    			}
    		}
    	}
